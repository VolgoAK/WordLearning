...
public class MyRoundBitmap extends Drawable {
    ...
    void updateDstRect() {
        ...
        if (mCornerRadius > minDimen * 0.35f) {
            ...
            float distRadius = maxRadius * 0.3f;
            float fraction = 1 - ((maxRadius - mCornerRadius)/ distRadius);
    ...
    public void setCornerRadius(float cornerRadius) {
        Log.d("TESTING", "Set corner radius");

        if (mCornerRadius == cornerRadius) {
            Log.d("TESTING", "Corners are equals");
            return;
        }
    ...
    MyRoundBitmap(Resources res, Bitmap bitmap) {
        if (res != null) {
